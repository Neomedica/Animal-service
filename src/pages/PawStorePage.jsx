...
const PRODUCTS = [
  { id:1, name:"สติ๊กเกอร์อุ้งมือ", desc:"สติ๊กเกอร์ลายน้องหมาน้องแมว ติดโน้ตบุ๊ค กระเป๋า ขวดน้ำ", emoji:"🐾", price:"฿120", tag:"Bestseller" },
  { id:2, name:"พรมหน้าประตูลายหมา", desc:"พรมน่ารักลายสุนัขพันธุ์ต่างๆ ขนาด 40x60 ซม.", emoji:"🐶", price:"฿390", tag:"New" },
  { id:3, name:"แก้วน้ำลายแมว", desc:"แก้ว Ceramic ลายแมวน่ารัก พร้อมฝาปิด ความจุ 350ml", emoji:"🐱", price:"฿280", tag:"" },
  { id:4, name:"กระเป๋าผ้าอุ้งมือ", desc:"กระเป๋าผ้า Canvas ลาย Furever Paw น่ารักสุดๆ", emoji:"👜", price:"฿199", tag:"Furever" },
  { id:5, name:"พวงกุญแจน้องหมา", desc:"พวงกุญแจอะคริลิครูปสุนัขพันธุ์ต่างๆ กว่า 20 แบบ", emoji:"🔑", price:"฿89", tag:"" },
  { id:6, name:"โปสการ์ดสัตว์เลี้ยง", desc:"โปสการ์ดลายน่ารัก เซ็ต 6 ใบ เหมาะสำหรับของขวัญ", emoji:"💌", price:"฿149", tag:"Gift" },
  { id:7, name:"แม่เหล็กติดตู้เย็น", desc:"แม่เหล็กลายสัตว์เลี้ยง เซ็ต 4 ชิ้น", emoji:"🧲", price:"฿99", tag:"" },
  { id:8, name:"สมุดโน้ตลายแมว", desc:"สมุดโน้ต A5 ปกแข็ง ลายแมวน่ารัก 120 หน้า", emoji:"📓", price:"฿175", tag:"" },
];

const QUIRKY = [
  { id:9, name:"ที่คั่นหนังสือรูปหาง", desc:"ที่คั่นหนังสืออะคริลิครูปหางแมว ยาว 15 ซม.", emoji:"😺", price:"฿69", tag:"Unique" },
  { id:10, name:"ถุงมือแมว", desc:"ถุงมือถักลายอุ้งเท้าแมว อบอุ่นและน่ารัก", emoji:"🧤", price:"฿220", tag:"Quirky" },
  { id:11, name:"หมวกหูแมว", desc:"หมวกไหมพรมมีหูแมว สำหรับทั้งคนและน้องหมา", emoji:"🎩", price:"฿299", tag:"Quirky" },
  { id:12, name:"เคสโทรศัพท์ลายสัตว์", desc:"เคสใส/ดำลายน้องหมาน้องแมว รองรับ iPhone/Samsung", emoji:"📱", price:"฿259", tag:"New" },
];
